    ...
    <div class="dashboard">
        <div class="left">
            ...
            <div  style="width: 800px;">
                <LineChart @on-selected="onSelected" tag="Product Listing Trend" :values="values" :date="dates" height="600px" />
            </div>
        </div>
        <div class="right">
        ...
        */
        ...
        onSelected(day) {
            this.$axios.get(`/dashboard/productShelvesInfo/${day}`).then(res => {
                ...
                console.log("Product listing trend error:", error);
            })
        },
        fetchStaticCount() {
            this.$axios.get('/dashboard/staticCount').then(res => {
                ...
                console.log("Basic data query error:", error);
            })
        },
        fetchProductList() {
            ...
            this.$axios.post('/product/query', productQueryDto).then(res => {
                ...
                console.log("Product information query error:", error);
            })
        },
    },
};
