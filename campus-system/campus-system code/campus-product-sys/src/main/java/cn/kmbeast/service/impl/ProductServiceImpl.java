...
public class ProductServiceImpl implements ProductService {
    ...
    public Result<String> buyProduct(OrdersDTO ordersDTO) {
        ...
        if (productVOS.isEmpty()) {
            return ApiResult.error("Product information error");
        }
        // 有且仅有一条商品信息
        ...
        if (productVO.getInventory() <= 0
            ...
            return ApiResult.error("Insufficient product stock");
        }
    ...
    public Result<String> refund(Integer ordersId) {
        ...
        ordersMapper.update(orders);
        return ApiResult.success("Refund request submitted successfully. Please wait for seller review");
    }
    ...
    public Result<List<ChartVO>> queryProductInfo(ProductQueryDto productQueryDto) {
        ...
        ChartVO chartVOLove = new ChartVO("Product Wants",(int)loveCount);
