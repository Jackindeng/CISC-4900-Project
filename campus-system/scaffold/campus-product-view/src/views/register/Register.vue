<template>
    <div class="register-containel">
        <div class="register-panel">
            ...
            <div class="text">
                <input v-model="act" class="act" placeholder="New Account" />
            </div>
            <div class="text">
                <input v-model="name" class="act" placeholder="New User Name" />
            </div>
            <div class="text">
            ...
            <div>
                <span class="register-btn" @click="registerFunc">Sign in</span>
            </div>
            <div class="tip">
    ...
    methods: {
        ...
        async registerFunc() {
            if (!this.act || !this.pwd || !this.pwdConfirm || !this.name ) {
                this.$swal.fire({
                    title: 'Fill in the verification',
                    text: 'The username, password, or name cannot be empty.',
                    icon: 'error',
            ...
            if (this.pwd !== this.pwdConfirm) {
                this.$swal.fire({
                    title: 'Fill in the verification',
                    text: 'The passwords entered before and after are inconsistent',
                    icon: 'error',
                    showConfirmButton: false,
                    timer: DELAY_TIME,
                });
