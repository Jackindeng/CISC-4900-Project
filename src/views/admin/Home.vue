    ...
    <div class="menu-container">
        <div class="menu-side" :class="{ 'menu-side-narrow': flag }">
            <div style="display: flex;align-items: center;">
                <Logo name="Campus Second-Hand" style="padding: 0 40px;margin: 15px 0;" :flag="flag" :bag="colorLogo" />
            </div>
        ...
        <el-dialog :show-close="false" :visible.sync="dialogOperaion" width="26%">
            <div slot="title" style="padding: 25px 0 0 20px;">
                <span style="font-size: 18px;font-weight: 800;">Profile</span>
            </div>
    ...
    methods: {
        async updateUserInfo() {
            try {
                ...
                console.error(`Error in modifying personal information:${e}`);
            }
        },
        ...
        async tokenCheckLoad() {
            try {
                ...
                if (targetMenu) {
                    ...
                    console.warn(`Route not found for role: ${rolePath}`);
                }
            } catch (error) {
                console.error('An error occurred while retrieving user authentication information:', error);
                this.$message.error('Auth info failed to load, please try again!');
            }
        },
    }
};
