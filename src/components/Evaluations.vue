<template>
    <div style="width: 100%;">
            ...
            <el-row style="margin: 15px 0;">
                ...
                <el-col :span="22">
                    <div class="parent-comment"
                        ...
                        <textarea class="comment-parent-input" v-model="content" placeholder="Please friendly talking." @focus="onFocus"
                        ...
                        <div>
                            ...
                            <el-button
                                ...
                                @click="commentClick" class="comment-clike" size="mini" type="primary">Post</el-button>
                        </div>
                    </div>
                </el-col>
            </el-row>
        ...
        <!-- 举报反馈对话框 -->
        <el-dialog style="user-select: none;border-radius: 5px;" title="Report" :visible.sync="dialogVisibleReport"
            width="30%">
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <button class="yes-btn" @click="operationReport">Submit</button>
            </span>
        </el-dialog>
    </div>
</template>
    ...
    methods: {
        ...
        upvote(comment) {
            ...
            this.$axios.put(`evaluations/update`, evalustions).then(res => {
                ...
                console.error(`The "like" status incorrect. -> `, err);
            })
        },
        // 确定举报
        operationReport() {
            ...
            if (!reportItem.length) {
                this.$message(`Please select a report item`);
                return;
            }
            this.$axios.get(`evaluations-reports/report/${this.comment.id}/${reportItem[0].name}`).then(res => {
                ...
                console.error(`Comment reporting anomaly-> `, err);
            })
        },
        // 选中举报项
        ...
        loadCommentList() {
            this.$axios.get(`evaluations/list/${this.contentId}/${this.contentType}`).then(res => {
                ...
                console.error(`Comment list load error -> `, err);
            })
        },
    }
};  
